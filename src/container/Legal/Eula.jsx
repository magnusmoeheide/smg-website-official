  ...
  return (
    <div className="legal">
      ...
      <p>
        ...
        permitted by this Licence Agreement), You indicate that You agree to be
        bound by all of the terms and conditions of this Licence Agreement, and
        that You accept this Licence Agreement. referred to in this Licence
        Agreement as <b>'Services'</b>.
      </p>
      <p>
        The parties of this Licence Agreement acknowledge that the Services are
      ...
      <p>
        Klassekartgenerator.no when accessed through the Services, is licensed
        to You for use only under the terms of this Licence Agreement. The
      ...
      <p>
        ...
        licence to use the Licensed Application on any Devices that You
      ...
      <p>
        ...
        the first Licensed Application, unless a separate licence is provided
        for such update, in which case the terms of that new licence will
        govern.
      </p>
      <p>
      ...
      <ul>
        ...
        Application and this Licence Agreement. <br />
        ...
        specific person or class of people. <br />
      ...
      <p>
        ...
        caused due to a breach of duties according to Section 2 of this Licence
      ...
      <p>
        ...
        Developer's End-User Licence Agreement', subsidiaries shall be
        third-party beneficiaries of this End User Licence Agreement and
        &mdash;upon Your acceptance of the terms and conditions of this Licence
        Agreement, will have the right (and will be deemed to have accepted the
